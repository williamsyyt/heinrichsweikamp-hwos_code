...
; Misc
        ...
        OPTION_UINT8p10 ocR_button_left, .20, .60,   .30,  tPercent,  .152,    opt_cR_button_left               ; left button sensitivity
        OPTION_UINT8p10 ocR_button_right,.20, .60,   .30,  tPercent,  .153,    opt_cR_button_right              ; right button sensitivity
